...
public class AccommodationScoreCalculator {
    ...
    public List<RecommendationResultVO> calculate(List<RecommendationMerchantVO> candidates,
        ...
        for (RecommendationMerchantVO candidate : candidates) {
            ...
            BigDecimal priceScore = calculatePriceScore(candidate.getPrice(), nightlyBudget);
    ...
    BigDecimal calculatePriceScore(BigDecimal price, BigDecimal budget) {
    ...
    BigDecimal calculateRatingScore(BigDecimal rating) {
    ...
    BigDecimal calculateAccessibilityScore(BigDecimal distanceKm) {
