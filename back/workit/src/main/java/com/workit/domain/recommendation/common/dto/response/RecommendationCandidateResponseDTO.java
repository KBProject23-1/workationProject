...
public class RecommendationCandidateResponseDTO {
    ...
    public static RecommendationCandidateResponseDTO from(RecommendationMerchantVO merchant) {
        return new RecommendationCandidateResponseDTO(merchant.getMerchantId(), merchant.getMerchantName(),
                merchant.getCategory(), merchant.getLatitude(), merchant.getLongitude(), merchant.isReserved());
    }
}
