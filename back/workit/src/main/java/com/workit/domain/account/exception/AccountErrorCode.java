...
public enum AccountErrorCode implements ErrorCode {
    ...
    LINKABLE_ACCOUNT_NOT_FOUND(HttpStatus.NOT_FOUND, "존재하지 않는 연동 가능 계좌입니다."),
    ACCOUNT_NOT_FOUND(HttpStatus.NOT_FOUND, "존재하지 않는 계좌입니다."),
    PRIMARY_ACCOUNT_DELETE_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "주 계좌는 삭제할 수 없습니다. 다른 계좌를 먼저 주 계좌로 설정해주세요.");
